    ...
    def parse_structure(self, lines, start_idx):
        ...
        while line != "end":
            if line.startswith("lattice"):
                ...
                cell_vec.append(
                    [
                        float(parts[1]) * self._bohr_to_ang,
                        float(parts[2]) * self._bohr_to_ang,
                        float(parts[3]) * self._bohr_to_ang,
                    ]
                )
                ...
                forces.append(
                    [
                        float(parts[7]) * self._hartree_to_ev / self._bohr_to_ang,
                        float(parts[8]) * self._hartree_to_ev / self._bohr_to_ang,
                        float(parts[9]) * self._hartree_to_ev / self._bohr_to_ang,
                    ]
                )
